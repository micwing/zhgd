/**
 * Description: 智慧工地-塔机监测系统-消息群发管理业务接口
 ...
 * @since 1.0
 */
public interface ITcsmMessageGroupPushService<T extends TcsmMessageGroupPushEntity> extends Service<T> {
}