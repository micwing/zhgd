/**
 * Description: 智慧工地-塔机监测系统-消息单人记录管理数据访问接口
 ...
 * @since 1.0
 */
public interface ITcsmMessagePersonRecordDao<T extends TcsmMessagePersonRecordEntity> extends Dao<T>{
}
