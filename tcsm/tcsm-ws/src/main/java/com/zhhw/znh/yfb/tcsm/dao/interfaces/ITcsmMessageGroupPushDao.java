/**
 * Description: 智慧工地-塔机监测系统-消息群发管理数据访问接口
 ...
 * @since 1.0
 */
public interface ITcsmMessageGroupPushDao<T extends TcsmMessageGroupPushEntity> extends Dao<T>{
}
