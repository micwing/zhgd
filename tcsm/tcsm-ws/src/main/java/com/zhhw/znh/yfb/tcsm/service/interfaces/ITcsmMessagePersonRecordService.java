/**
 * Description: 智慧工地-塔机监测系统-消息单人记录管理业务接口
 ...
 * @since 1.0
 */
public interface ITcsmMessagePersonRecordService<T extends TcsmMessagePersonRecordEntity> extends Service<T> {
}