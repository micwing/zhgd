/**
 * Description: 智慧工地-塔机监测系统-报警推送设置业务接口
 ...
 * @since 1.0
 */
public interface ITcsmMessagePushSetService<T extends TcsmMessagePushSetEntity> extends Service<T> {
}