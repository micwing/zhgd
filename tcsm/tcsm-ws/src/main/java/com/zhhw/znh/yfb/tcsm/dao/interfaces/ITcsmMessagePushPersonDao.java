/**
 * Description: 智慧工地-塔机监测系统-报警消息推送用户数据访问接口
 ...
 * @since 1.0
 */
public interface ITcsmMessagePushPersonDao<T extends TcsmMessagePushPersonEntity> extends Dao<T>{
}
