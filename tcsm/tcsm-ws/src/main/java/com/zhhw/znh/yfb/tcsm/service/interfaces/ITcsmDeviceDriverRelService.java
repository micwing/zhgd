/**
 * Description: 智慧工地-塔机监控系统-设备司机关联业务接口
 ...
 * @since 1.0
 */
public interface ITcsmDeviceDriverRelService<T extends TcsmDeviceDriverRelEntity> extends Service<T> {
}