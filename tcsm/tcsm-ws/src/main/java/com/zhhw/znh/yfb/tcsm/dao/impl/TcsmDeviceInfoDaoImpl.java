/**
 * Description: 智慧工地-塔机监控系统-塔机设备数据访问实现类
 ...
 * @since 1.0
 */
@Repository("tcsmDeviceInfoDao")
public class TcsmDeviceInfoDaoImpl extends DefaultDaoImpl<TcsmDeviceInfoEntity> implements ITcsmDeviceInfoDao<TcsmDeviceInfoEntity>{
}
