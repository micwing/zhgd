/**
 * Description: 智慧工地-塔机监控系统-设备实时数据日志业务接口
 ...
 * @since 1.0
 */
public interface ITcsmSnapCurrentService<T extends TcsmSnapCurrentEntity> extends Service<T> {
}