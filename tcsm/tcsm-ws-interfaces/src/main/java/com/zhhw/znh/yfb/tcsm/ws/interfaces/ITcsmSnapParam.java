 ...
 * @since 1.0
 */
public interface ITcsmSnapParam {
     ...
     */
    TcsmSnapParamListResponse getTcsmSnapParamList(
            TcsmSnapParamListRequest request);
     ...
     */
    TcsmSnapParamResponse addTcsmSnapParam(TcsmSnapParamRequest request);
     ...
     */
    TcsmSnapParamResponse deleteTcsmSnapParamById(Long id);
     ...
     */
    TcsmSnapParamResponse updateTcsmSnapParam(
            TcsmSnapParamRequest request);
     ...
     */
    TcsmSnapParamResponse getTcsmSnapParamById(Long id);
}
