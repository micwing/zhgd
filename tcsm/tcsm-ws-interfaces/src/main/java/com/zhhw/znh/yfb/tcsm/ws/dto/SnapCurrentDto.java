...
public class SnapCurrentDto implements java.io.Serializable {
	...
	private SnapCurrentDataBody data_body;
	...
	public SnapCurrentDataBody getData_body() {
		return data_body;
	}

	public void setData_body(SnapCurrentDataBody data_body) {
